...
def main():
    ...
    rural = [ho_all["values"][(ho_all["location"] == "Rural") & (ho_all["GroundOrAir"] == "Air")],
            ho_all["values"][(ho_all["location"] == "Rural") & (ho_all["GroundOrAir"] == "Ground")]]
    urban = [ho_all["values"][(ho_all["location"] == "Urban") & (ho_all["GroundOrAir"] == "Air")],
            ho_all["values"][(ho_all["location"] == "Urban") & (ho_all["GroundOrAir"] == "Ground")]]
